...
fridayComs.push("what is weather");
...
window.onload = () => {
  ...
  turn_on.addEventListener("ended", () => {
    setTimeout(() => {
      ...
      if (localStorage.getItem("nexus_setup") === null) {
        readOut(
...
recognition.onresult = function (event) {
  ...
  if(localStorage.getItem("lang") === "en-US"){
    if (transcript.includes("hello nexus")) {
      readOut("hello sir");
    }
